...
#include <cam_lidar_calib/sf_Info_2.h>
...
public:
    ...
    lidarImageProjection() {
        ...
        detection_sub = new message_filters::Subscriber<yolov7_ros::DetectionInfo>(nh, "/detect_info_drum", 1);
        ...
        sf_info_pub = nh.advertise<cam_lidar_calib::sf_Info_2>("sf_info_2", 1000);
    ...
    void callback(const sensor_msgs::PointCloud2ConstPtr &cloud_msg,
        ...
        //publish
        cam_lidar_calib::sf_Info_2 sf_msg;
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "cam_lidar_proj_2");
